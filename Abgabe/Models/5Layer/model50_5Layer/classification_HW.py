...
class CNNClassification(nn.Module):
    def __init__(self):
        ...
        self.network = nn.Sequential(
            ...
            nn.Flatten(),
            nn.Linear(512*6*8, 2048),  # Angepasste Dimension basierend auf Eingangsdaten
            nn.ReLU(),
            nn.Linear(2048, 128),
            nn.ReLU(),
...
if __name__ == '__main__':
    ...
    train_model(data_dir, device, epochs=60,modelname=model)
